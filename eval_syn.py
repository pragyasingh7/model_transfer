...
class SynEvaluate(torch.utils.data.Dataset):
    def __init__(self, pred_path, gt_path, iou_thres=0.2, min_size=200, margin=(14, 64, 64)):
        ...
        valid_mask[self.margin[0]:-self.margin[0], 
                   self.margin[1]:-self.margin[1],
                   self.margin[2]:-self.margin[2]] = 1
        ...
        self.gt_cleft[np.where(self.gt_cleft==65535)] = 0
...
if __name__ == "__main__":
    ...
    pred_08nm_path = '/n/coxfs01/vcg_connectomics/human/roi215/tim/964355253395_w08_roi215_subset_predictions_20190207_8x8.h5'
    ...
    Eva_08nm = SynEvaluate(pred_08nm_path, gt_path, iou_thres=float(sys.argv[1]))
